...
.app-sidebar__nav { padding: var(--spacing-md); }
.app-sidebar__item {
  display: block;
...
.app-sidebar__item:hover { background: var(--color-bg-hover); color: var(--color-text); }
.app-sidebar__item.active { background: var(--color-primary); color: #fff; }
</style>